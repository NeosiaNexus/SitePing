...
Événements publics : `feedback:sent` (charge utile : le feedback créé), `feedback:deleted` (charge utile : l'id), `panel:open`, `panel:close`. `on()` renvoie une fonction de désabonnement.
